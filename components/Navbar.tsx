...
export default async function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-[var(--color-glass-border)] bg-[var(--color-glass-bg)] backdrop-blur-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 relative flex items-center justify-center">
            <Image src="/logoupa.png" alt="Logo UPA" fill className="object-contain" priority />
          </div>
